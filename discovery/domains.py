...
DOMAINS = {
    "drug_discovery": {
        ...
        "enrichment": ["pubchem", "openfda", "pdb", "nist", "semantic_scholar", "clinicaltrials", "alphafold", "kegg"],
        "generation": "molecule",
    ...
    "materials_science": {
        ...
        "enrichment": ["pubchem", "materials_project", "nist", "semantic_scholar"],
        "generation": "material",
    ...
    "physics": {
        ...
        "enrichment": ["arxiv", "semantic_scholar", "inspire_hep", "ligo"],
        "generation": "hypothesis",
    ...
    "chemistry": {
        ...
        "enrichment": ["cir", "pubchem", "nist", "semantic_scholar"],
        "generation": "hypothesis",
